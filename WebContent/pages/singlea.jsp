...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
    ...
    <div class="container singleproduct_container">
		<div class="row">
			<div class="col">
				...
				<div class="breadcrumbs d-flex flex-row align-items-center">
					<ul>
						...
						<li class="active"><a href="#"><i class="fa fa-angle-right" aria-hidden="true"></i><%= product.getNome()%></a></li> <!-- STESSO NOME DEL PRODOTTO NEL TITOLO -->
					</ul>
				</div>
		...
		<div class="row">
					...
					<div class="row">
						<div class="col-lg-3 thumbnails_col order-lg-1 order-2">
							<div class="single_product_thumbnails">
								<ul>
									<%
										String img1 = "static/images/" + product.getImg1();
										String img2 = "static/images/" + product.getImg2();
										String img3 = "static/images/" + product.getImg3();
									%>
									<li><img src="<%=img1%>" alt="" data-image="<%=img1%>"></li> <!-- NOMI DELLE FOTO 1-2-3 -->
									<li class="active"><img src="<%=img2%>" alt="" data-image="<%=img2%>"></li> <!-- NOMI DELLE FOTO 1-2-3 -->
									<li><img src="<%=img3%>" alt="" data-image="<%=img3%>"></li> <!-- NOMI DELLE FOTO 1-2-3 -->
								</ul>
							</div>
						</div>
						<div class="col-lg-9 image_col order-lg-2 order-1">
							<div class="single_product_image">
								<div class="single_product_image_background" style="background-image:url(<%=img2%>)"></div> <!-- NOMI DELLA FOTO 2 DISPLAY DEFAULT -->
							</div>
						</div>
					</div>
				</div>
			...
			<div class="col-lg-5">
				<div class="product_details">
					...
					<div class="original_price">$<%=product.getPrezzo()%></div> <!-- PREZZO DEFAULT -->
					...
					<div class="quantity d-flex flex-column flex-sm-row align-items-sm-center"> <!-- CARRELLO (DA CANCELLARE SE NON VOGLIAMO GESTIRLO ORA) -->
						...
						<div class="red_button carrello_button"><a href="#">Aggiungi al carrello</a></div>
					...
					<div id="tab_1" class="tab_container active">
						<div class="row">
							...
							<div class="col-lg-5 offset-lg-2 desc_col">
								<div class="tab_image">
									<img src="<%=img2%>" alt=""> <!-- NOMI DELLA FOTO 2 DISPLAY DEFAULT -->
								</div>
							</div>
						</div>
					</div>
