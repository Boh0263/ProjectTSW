		...
		<div class="content">
			<%
				...
				if (request.getParameter("emailRec") != null) {
					Email = request.getParameter("emailRec");
					action = "RecensioneControl?action=aggiungiMod&emailRec=" + Email + "&codice=" + request.getParameter("codice");
				}
			%>
			<form action="<%=action%>" METHOD="POST">
				<div class="user-details" style="display: block">
					...
					<div class="input-box">
						...
						<textarea id="testo" name="Commento" rows="4" cols="60" placeholder="Aggiungi testo della recensione (opzionale)..." style="resize: none; width: 600px; height: 160px" style="margin-bottom: 30px"><%=request.getParameter("testo")%></textarea> <!-- 93 -->
						<%
							} else {
						%>
						<span class="details">Testo (opzionale)</span>
						<textarea id="testo" name="Commento" rows="4" cols="60" placeholder="Aggiungi testo della recensione (opzionale)..." style="resize: none; width: 600px; height: 160px" style="margin-bottom: 30px"></textarea> <!-- 93 -->
						<%
							}
						%>
					</div>
